 ...
 * 2015-11-20T23:01:51.557-05:00
 * Generated source version: 3.0.2
 * 
 */
@WebServiceClient(name = "IBankAccountServiceService", 
                  wsdlLocation = "file:/Users/AjmalCholassery/git/SpringCxfWebServiceClientCXF/src/main/resources/IBankAccountService.wsdl",
...
public class IBankAccountServiceService extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("file:/Users/AjmalCholassery/git/SpringCxfWebServiceClientCXF/src/main/resources/IBankAccountService.wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(IBankAccountServiceService.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "file:/Users/AjmalCholassery/git/SpringCxfWebServiceClientCXF/src/main/resources/IBankAccountService.wsdl");
        }
        WSDL_LOCATION = url;
    }
